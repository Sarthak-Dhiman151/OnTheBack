    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] w-full max-w-6xl mx-auto px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
        ...
        >
          ...
          <div className="w-24 h-24 rounded-2xl bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-8 group-hover:bg-blue-600 group-hover:text-white dark:group-hover:bg-blue-500 transition-colors duration-300 shadow-inner">
          ...
          <p className="text-sm font-mono text-stone-500 dark:text-stone-400 uppercase tracking-widest leading-relaxed max-w-[200px]">
            Three in a row wins. The ultimate classic.
          </p>
        ...
        >
          ...
          <div className="w-24 h-24 rounded-2xl bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-8 group-hover:bg-emerald-600 group-hover:text-white dark:group-hover:bg-emerald-500 transition-colors duration-300 shadow-inner">
          ...
          <p className="text-sm font-mono text-stone-500 dark:text-stone-400 uppercase tracking-widest leading-relaxed max-w-[200px]">
            Five in a row wins. Strategy on a grand scale.
          </p>
